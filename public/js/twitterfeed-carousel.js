...
$(document).ready(function(){
	...
	var headerHTML = '';
	var loadingHTML = '';
	headerHTML += '<div id="twitter-header"><a href="https://twitter.com/" target="_blank"><img src="/images/pictures/home/1.jpg" width="34" style="float:left;padding:3px 12px 0px 6px" alt="twitter bird" /></a>';
	...
	loadingHTML += '<div id="loading-container" style="height:'+feedheight+'px;"><img src="" width="32" height="32" alt="tweet loader" /></div>';
